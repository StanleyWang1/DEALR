...
def dispense(motor_controller, current_position):
    motor_controller.write(MOTOR_ID, control_table.GOAL_POSITION, current_position + DISPENSE_STEP)
    time.sleep(0.1)
    while True: 
        ...
        time.sleep(0.1)
    return current_position + DISPENSE_STEP
...
motor_controller.write(MOTOR_ID, control_table.PROFILE_VELOCITY, 200) # set velocity
...
while True:
    ...
    current_position = dispense(motor_controller, current_position)
